package ss16_io_text_file.exerise.readfile.controller;

import ss16_io_text_file.exerise.readfile.model.Student;
...
public class MainController {
    ...
    private static void writeFile(List<Student> students) throws IOException {
        File file = new File("src/ss16_io_text_file/exerise/readfile/data/student.txt");
